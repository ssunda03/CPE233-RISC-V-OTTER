...
module OTTER_Wrapper(
   ...
   logic [7:0]  r_segs = 0;   //  register for segments (cathodes)
   logic [15:0] r_leds = 0;   //  register for LEDs
   logic [3:0]  r_an = 0;     //  register for display enables (anodes)
   
   logic db_intr, pos_pulse, neg_pulse;
   ...
   OTTER_MCU  my_otter(
    ...
    one_shot_bdir  #(.n(3)) my_oneshot (
        .clk           (s_clk),
        .sig_in        (db_intr),
        .pos_pulse_out (pos_pulse), 
        .neg_pulse_out (neg_pulse)  );
